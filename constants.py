...
BULLET_SPRITE_PATH = ':resources:images/space_shooter/laserBlue01.png'
...
SHOOT_SPEED_PX_PER_FRAME = 15
BULLET_SPEED_PX_PER_FRAME = 12
BULLET_DAMAGE = 25
...
SHOOT_SOUND_EFFECT = f'{SOUND_EFFECT_PATH}hurt5.wav'
HIT_SOUND_EFFECT = f'{SOUND_EFFECT_PATH}hit5.wav'
